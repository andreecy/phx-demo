...
config :habit_tracker, HabitTrackerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "WM7u+uG2CF7ierA+VCZaxk7Z10KUVy5VH5xMvASHMD1WKq+5fOBHFdC6fU0TjVMc",
  watchers: [
...
config :habit_tracker, HabitTrackerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/habit_tracker_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :habit_tracker, dev_routes: true
